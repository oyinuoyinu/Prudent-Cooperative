...
# Security
CSRF_TRUSTED_ORIGINS = ['https://*.prudentwomen.org']
...
if DEBUG:
    ...
    EMAIL_PORT = 587
    EMAIL_USE_TLS = True
    EMAIL_HOST_USER = "info@prudentwomen.org"
...
DEFAULT_FROM_EMAIL = 'Prudent Women Cooperative <info@prudentwomen.org>'
...
CSRF_TRUSTED_ORIGINS = ['https://app.prudentwomen.org', 'https://www.app.prudentwomen.org']
