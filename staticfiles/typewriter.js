...
typewriter.pauseFor(2500)
    .typeString('Bringing veterinary care to your <span style="color: #ee5050;"> doorstep.</span>')
    .pauseFor(2500)
    .deleteAll()
    .typeString('Connecting pet owners with vet doctors,<span style="color: #ee5050;"> anytime</span>')
    .pauseFor(2500)
    .deleteChars(7)
    .typeString('<span class="text-secondary">anywhere.</span>')
    .pauseFor(1500)
    .start()
